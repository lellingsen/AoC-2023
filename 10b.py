...
# identify what is the pipe we're worried about
# then everything that could be inside... but
# we have to check for what is connected to the outside
# how do we handle going "between the pipes" though?
